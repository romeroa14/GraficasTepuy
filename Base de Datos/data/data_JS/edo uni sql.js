('','edo0001','uni0001','Amazonas'),
('','edo0002','uni0002','Anzoátegui'),
('','edo0003','uni0003','Aragua'),
('','edo0004','uni0004','Apure'),
('','edo0005','uni0005','Barinas'),
('','edo0006','uni0006','Bolívar'),
('','edo0007','uni0007','Carabobo'),
('','edo0008','uni0008','Cojedes'),
('','edo0009','uni0009','Delta Amacuro'),
('','edo0010','uni0010','Distrito Capital'),
('','edo0011','uni0011','Falcón'),
('','edo0012','uni0012','Guárico'),
('','edo0013','uni0013','Lara'),
('','edo0014','uni0014','La Guaira'),
('','edo0015','uni0015','Nueva Esparta'),
('','edo0016','uni0016','Mérida'),
('','edo0017','uni0017','Miranda'),
('','edo0018','uni0018','Monagas'),
('','edo0019','uni0019','Portuguesa'),
('','edo0020','uni0020','Sucre'),
('','edo0021','uni0021','Trujillo'),
('','edo0022','uni0022','Táchira'),
('','edo0023','uni0023','Yaracuy'),
('','edo0024','uni0024','Zulia');



('1','edo0001','uni0002','(UNATUR) - Universidad Nacional Del Turismo'),
('2','edo0002','uni0002','(UPTJAA) - Universidad Politécnica Territorial José Antonio Anzoátegui'),
('3','edo0003','uni0003','(UPTAFBF) - Universidad Politécnica Territorial Del Estado Aragua Federico Brito Figueroa'),
('4','edo0004','uni0004',' (UPTALTAP) - Universidad Politécnica Territorial Del Alto Apure Pedro Camejo'),
('5','edo0005','uni0005','(UNELLEZ) - Universidad Nacional Experimental De Los Llanos Occidentales Ezequiel Zamora'),
('6','edo0006','uni0005',' (UPTBJFR) - Universidad Politécnica Territorial Del Estado Barinas José Félix Ribas'),
('7','edo0007','uni0006','(UNEG) - Universidad Nacional Experimental De Guayana'),
('8','edo0008','uni0006','(UVH) INTEVEP - Universidad Venezolana De Hidrocarburos'),
('9','edo0009','uni0006',' (UNEIT) - Universidad Nacional Experimental Indígena Del Taúca'),
('10','edo0010','uni0006',' (UPTB) - Universidad Politécnica Territorial Estado Bolívar'),
('11','edo0011','uni0006','(UNEXEE) - Universidad Nacional Experimental De Especialidades Eléctricas'),
('12','edo0012','uni0007','(UC) - Universidad Carabobo'),
('13','edo0013','uni0007','(UPTPC) - Universidad Politécnica Territorial De Puerto Cabello'),
('14','edo0014','uni0007','(UPTV) - Universidad Politécnica Territorial De Valencia'),
('15','edo0015','uni0008','(UDS) - Universidad Deportiva Del Sur'),
('16','edo0016','uni0009','(UTDFT) - Universidad Territorial Deltaica Francisco Tamayo'),
('17','edo0017','uni0010','(UCV) - Universidad Central De Venezuela'),
('18','edo0018','uni0010','(UNESR) - Universidad Nacional Experimental Simón Rodríguez'),
('19','edo0019','uni0010','(UNA) - Universidad Nacional Abierta'),
('20','edo0020','uni0010','(UPEL) - Universidad Pedagógica Experimental Libertador'),
('21','edo0021','uni0010','(UNEFA) - Universidad Nacional Experimental Politécnica De La Fuerza Armada Bolivariana (Distrito Capital, Caracas'),
('22','edo0022','uni0010','(UBV) - Universidad Bolivariana De Venezuela'),
('23','edo0023','uni0010','(ULAC) - Universidad Latinoamericana Y Del Caribe'),
('24','edo0024','uni0010','(UNEARTES) - Universidad Nacional Experimental De Las Artes'),
('25','edo0025','uni0010','(UBTJFR) - Universidad Bolivariana De Los Trabajadores Jesús Rivero'),
('26','edo0026','uni0010','(UNES) - Universidad Nacional Experimental De La Seguridad'),
('27','edo0027','uni0010','(UMBV) Universidad Militar Bolivariana De Venezuela'),
('28','edo0028','uni0010','(UMB) - Universidad De Las Ciencias De La Salud Hugo Chávez Frías (UCS - Distrito Capital, Caracas)'),
('29','edo0029','uni0010','(UPAFV) - Universidad Popular Del Ambiente Fruto Vivas'),
('30','edo0030','uni0010','(UNEXCA) - Universidad Nacional Experimental De La Gran Caracas'),
('31','edo0031','uni0010','(UNETI) - Universidad Nacional De Las Telecomunicaciones E Informática'),
('32','edo0032','uni0010','(UNEM) - Universidad Nacional Experimental Del Magisterio Samuel Robinsón'),
('33','edo0033','uni0010','(UNET) - Universidad Nacional Experimental De Transporte'),
('34','edo0034','uni0010','(UPTCMS) - Universidad Politécnica Territorial De Caracas Mariscal Sucre'),
('35','edo0035','uni0010','(UBC) - Universidad Bolivariana De Las Comunas'),
('36','edo0036','uni0010','(LAUICOM) - Universidad Internacional De Las Comunicaciones'),
('37','edo0037','uni0011','(UNEFM) - Universidad Nacional Experimental Francisco De Miranda'),
('38','edo0038','uni0011','(UPTFAG) - Universidad Politécnica Territorial De Falcon Alonso Gamero'),
('39','edo0039','uni0012','(UNERG) - Universidad Nacional Experimental Rómulo Gallegos'),
('40','edo0040','uni0012','(UPTLL) - Universidad Politécnica Territorial Llanos Juana Ramírez'),
('41','edo0041','uni0013','(UCLA) - Universidad Centro Occidental Lisandro Alvarado'),
('42','edo0042','uni0013','(UNEXPO) - Universidad Nacional Experimental Politécnica Antonio José De Sucre'),
('43','edo0043','uni0013','(UPTLAEB) - Universidad Politécnica Territorial Del Estado Lara Andrés Eloy Blanco'),
('44','edo0044','uni0013','(UCVAG) - Universidad Campesina De Venezuela Argimiro Gabaldón'),
('45','edo0045','uni0013','(UNELMLK) - Universidad Nacional Experimental De Lara Martín Luther King'),
('46','edo0046','uni0014','(UMC) - Universidad Nacional Experimental Marítima Del Caribe'),
('47','edo0047','uni0016','(UPTMKR) - Universidad Politécnica Territorial De Mérida Kléber Ramírez'),
('48','edo0048','uni0016','(ULA) - Universidad Los Andes'),
('49','edo0049','uni0017','(UPTBAL) - Universidad Politécnica Territorial De Barlovento Argelia Laya'),
('50','edo0050','uni0017','(UPTAMCA) - Universidad Politécnica Territorial De Los Altos Mirandinos Cecilio Acosta'),
('51','edo0051','uni0017','(UPTVT) - Universidad Politécnica Territorial De Los Valles Del Tuy'),
('52','edo0052','uni0017','(USB) - Universidad Nacional Experimental Simón Bolívar'),
('53','edo0053','uni0017','(IDEA) - Fundación Instituto De Estudios Avanzados'),
('54','edo0054','uni0018','(UPTNM) - Universidad Politécnica Territorial Del Norte De Monagas Ludovico Silva'),
('55','edo0055','uni0019','(UPTPJJM) - Universidad Politécnica Territorial De Portuguesa Juan De Jesús Montilla'),
('56','edo0056','uni0020','(UDO) -  Universidad De Oriente'),
('57','edo0057','uni0020','(UPTOSCR) - Universidad Politécnica Territorial Del Oeste De Sucre Clodosbaldo Russian'),
('58','edo0058','uni0020','(UPTPLMR) - Universidad Politécnica Territorial De Paria Luis Mariano Rivera'),
('59','edo0059','uni0021','(UPTETMBI) - Universidad Politécnica Territorial Del Estado Trujillo Mario Briceño Iragorry'),
('60','edo0060','uni0022','(UNET) - Universidad Nacional Experimental Del Táchira'),
('61','edo0061','uni0022','(UPTNTMS) - Universidad Politécnica Territorial Del Norte Del Táchira Manuela Sáenz'),
('62','edo0062','uni0022','(UPTAIET) - Universidad Politécnica Territorial Agroindustrial Del Estado Táchira'),
('63','edo0063','uni0023','(UNEY) - Universidad Nacional Experimental Del Yaracuy'),
('64','edo0064','uni0023','(UPTYAB) - Universidad Politecnica Territorial De Yaracuy Arístide Bastidas'),
('65','edo0065','uni0024','(UNESUR) - UNIVERSIDAD NACIONAL EXPERIMENTAL SUR DEL LAGO JESÚS María SEMPRUM'),
('66','edo0066','uni0024','(UNERMB) - Universidad Nacional Experimental Rafael María Baralt'),
('67','edo0067','uni0024','(LUZ) - Universidad Del Zulia'),
('68','edo0068','uni0024','(UPTM) - Universidad Politécnica Territorial De Maracaibo'),
('69','edo0069','uni0024','(UPTZ) - Universidad Politécnica Territorial Zulia');
