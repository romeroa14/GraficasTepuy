...
// // select_1.innerHTML += `<option value="Todos">Todos</option>`

// // for (const estado in listaEstaMuni) {
// //     select_1.innerHTML += `<option value="${estado}">${estado}</option>`
// // }

// // Eventos para cada select
// select_1.addEventListener('change', function() {
//     if (select_1.value == "Todos") {
//         select_2.disabled = true;
//         buscarMunicipio = null;
//     } 
//     else {
//         // const estado = listaEstaMuni[select_1.value].municipios
//         // select_2.innerHTML = '<option disabled selected>Municipio</option>'
//         // select_2.innerHTML += '<option value="Todos">Todos</option>'
//         // estado.forEach(municipio => {
//         //     select_2.innerHTML += `<option value="${municipio}">${municipio}</option>`
//         // });
//         select_2.disabled = false;
//         select_tipo.disabled = false;
//     }

//     buscarEstado = select_1.value
    // mostrarUnis(buscarEstado, buscarMunicipio, buscarTipo)
// })

// select_2.addEventListener('change', function(){
//     buscarMunicipio = select_2.value
//     mostrarUnis(buscarEstado, buscarMunicipio, buscarTipo)
// })
